...
public class NewClass_1 {
    static type[][] arrange_new(type[][] res,type ans,int m,int n){
        
     if(ans.getbench().equals("BB")){
       int f=0;
       for(int r=m-1;r>=0 ;r--){
         for(int k=n-1;k>=0;k--){
...
ans[gg][ff].print();
arrange_new(res,ans[gg][ff],mm,nn);
}
}
